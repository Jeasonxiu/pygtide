...
if not sys.version_info[0] in [2,3]:
    print('Sorry, earthides not supported in your Python version')
...
long_description = 'A tool for modeling earth tides'
...
setup(name='earthtides',
      description = 'Model Earthtide Data',
      long_description = long_description,
      version = '0.0.1',
      author = 'Paul Inkenbrandt',
      author_email = 'paulinkenbrandt@utah.gov',
      url = 'https://github.com/inkenbrandt/pygtide',
      license = 'LICENSE.txt',
