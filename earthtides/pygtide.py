...
import earthtides.etpred as etpred
import numpy as np
import pandas as pd
#import earthtides.commdat as commdat

import sys
sys.path.append("/earthtides/")

def testdir():
    return os.listdir("commdat")
...
class pygtide(object):
    ...
    def __init__(self, msg=True):
        ...
        #etpred.params.comdir = b'/commdat  '
...
#            print(etpred.inout.etpdata[:,1])
    ...
    def update_etddt(self):
        ...
        from earthtides.pygtide_update_data import etddt
    ...
    def update_etpolut1(self):
        # import update routines
        from earthtides.pygtide_update_data import etpolut1
